...
func (uc *UserCreate) AddOrdererIDs(ids ...int) *UserCreate {
	uc.mutation.AddOrdererIDs(ids...)
	return uc
}

// AddOrderer adds the "orderer" edges to the Order entity.
func (uc *UserCreate) AddOrderer(o ...*Order) *UserCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uc.AddOrdererIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.OrdererIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
