...
// HasOrderer applies the HasEdge predicate on the "orderer" edge.
func HasOrderer() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOrdererWith applies the HasEdge predicate on the "orderer" edge with a given conditions (other predicates).
func HasOrdererWith(preds ...predicate.Order) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOrdererStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
