...
func (uu *UserUpdate) AddOrdererIDs(ids ...int) *UserUpdate {
	uu.mutation.AddOrdererIDs(ids...)
	return uu
}

// AddOrderer adds the "orderer" edges to the Order entity.
func (uu *UserUpdate) AddOrderer(o ...*Order) *UserUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uu.AddOrdererIDs(ids...)
}
...
// ClearOrderer clears all "orderer" edges to the Order entity.
func (uu *UserUpdate) ClearOrderer() *UserUpdate {
	uu.mutation.ClearOrderer()
	return uu
}

// RemoveOrdererIDs removes the "orderer" edge to Order entities by IDs.
func (uu *UserUpdate) RemoveOrdererIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveOrdererIDs(ids...)
	return uu
}

// RemoveOrderer removes "orderer" edges to Order entities.
func (uu *UserUpdate) RemoveOrderer(o ...*Order) *UserUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uu.RemoveOrdererIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.OrdererCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
			Columns: []string{user.OrdererColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := uu.mutation.RemovedOrdererIDs(); len(nodes) > 0 && !uu.mutation.OrdererCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
	...
	if nodes := uu.mutation.OrdererIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
...
// AddOrdererIDs adds the "orderer" edge to the Order entity by IDs.
func (uuo *UserUpdateOne) AddOrdererIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.AddOrdererIDs(ids...)
	return uuo
}

// AddOrderer adds the "orderer" edges to the Order entity.
func (uuo *UserUpdateOne) AddOrderer(o ...*Order) *UserUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uuo.AddOrdererIDs(ids...)
}
...
// ClearOrderer clears all "orderer" edges to the Order entity.
func (uuo *UserUpdateOne) ClearOrderer() *UserUpdateOne {
	uuo.mutation.ClearOrderer()
	return uuo
}

// RemoveOrdererIDs removes the "orderer" edge to Order entities by IDs.
func (uuo *UserUpdateOne) RemoveOrdererIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.RemoveOrdererIDs(ids...)
	return uuo
}

// RemoveOrderer removes "orderer" edges to Order entities.
func (uuo *UserUpdateOne) RemoveOrderer(o ...*Order) *UserUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uuo.RemoveOrdererIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.OrdererCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
	...
	if nodes := uuo.mutation.RemovedOrdererIDs(); len(nodes) > 0 && !uuo.mutation.OrdererCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
	...
	if nodes := uuo.mutation.OrdererIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   user.OrdererTable,
